...
///
/// Zoom travel is not described here: fixtures with a calibrated zoom express it as
/// degree-valued Zoom parameter metadata, which is the single source of beam angle.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[typeshare::typeshare]
#[serde(rename_all = "camelCase")]
