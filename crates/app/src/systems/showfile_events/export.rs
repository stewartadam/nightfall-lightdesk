...
fn collect_fixtures(
    ...
    #[cfg(feature = "fixture-library")]
    {
        ...
        for fixture in &snapshot.fixtures {
            // Package the definition the fixture renders with: its own revision,
            // or the compatible fallback used when that revision is gone.
            match library.profile_for_fixture(fixture) {
